              ...
              if (!snapshot.hasData)
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) => ListTile(
                    title: Text(snapshot.data[index].tipo + ' ' + snapshot.data[index].cantidad.toString() + ' ' + snapshot.data[index].unidadMedida),
                    subtitle: Text('\$' + snapshot.data[index].precioTotal.toString()),
                  ),
                );
            }),
      ),
